...
type
  GuiBridgeActionTag* = enum
    ...
    gbatClearDraftTitle,
    gbatSetDraftBacklog,
    gbatSetDraftInProgress,
    gbatSetDraftBlocked,
    gbatSetDraftPriorityLow,
    gbatSetDraftPriorityMedium,
    gbatSetDraftPriorityHigh,
    gbatSetDraftPriorityUrgent,
    gbatApplySearch,
    gbatClearSearch,
    gbatSetFilterAll,
    gbatSetFilterOpen,
    gbatSetFilterDone,
    gbatSetFilterBlocked,
    gbatSetSortNewest,
    gbatSetSortDueSoonest,
    gbatSetSortPriority,
    gbatSelectTask,
    gbatRenameActiveTask,
    gbatSetActiveDueDate,
    gbatClearActiveDueDate,
    gbatSetActiveStatusBacklog,
    gbatSetActiveStatusInProgress,
    gbatSetActiveStatusBlocked,
    gbatSetActiveStatusDone,
    gbatCompleteActiveTask,
    gbatReopenActiveTask,
    gbatRemoveActiveTask,
    gbatClearCompleted,
    gbatLoadDemoData,
    gbatResetTodos,
    gbatPersistPreferences,
    gbatMoveActiveTaskUp,
    gbatMoveActiveTaskDown
